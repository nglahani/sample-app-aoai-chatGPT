...
AZURE_OPENAI_SYSTEM_MESSAGE = os.environ.get("AZURE_OPENAI_SYSTEM_MESSAGE", "You are an AI administrative assistant at a healthcare clinic responsible for generating after-visit summaries and action items for patients after their visits.")
